...
def populate_halls(apps,schema_editor):
	...
	h1 = ConferenceHall.objects.create(branch_id=b1,name="Hakaba VIP Room",theatre_cap=35,classroom_cap=18,ushape_cap=18,reception_cap=25)
	h2 = ConferenceHall.objects.create(branch_id=b1,name="Daalo Banquet Hall",theatre_cap=200,classroom_cap=40,ushape_cap=60,reception_cap=220)
	h3 = ConferenceHall.objects.create(branch_id=b1,name="Ogo Villa 1 Room",theatre_cap=30,classroom_cap=15,ushape_cap=20,reception_cap=25)
	h4 = ConferenceHall.objects.create(branch_id=b1,name="Gezira VIP Room",theatre_cap=290,classroom_cap=180,ushape_cap=100,reception_cap=330)
	h5 = ConferenceHall.objects.create(branch_id=b1,name="Jilib Room",theatre_cap=150,classroom_cap=80,ushape_cap=55,reception_cap=180)
	h6 = ConferenceHall.objects.create(branch_id=b1,name="Golis Room",theatre_cap=160,classroom_cap=100,ushape_cap=60,reception_cap=190)
	h7 = ConferenceHall.objects.create(branch_id=b1,name="Camel Room",theatre_cap=70,classroom_cap=30,ushape_cap=25,reception_cap=50)
	h8 = ConferenceHall.objects.create(branch_id=b1,name="Damo Villa 2 Room",theatre_cap=25,classroom_cap=12,ushape_cap=18,reception_cap=20)
	h9 = ConferenceHall.objects.create(branch_id=b1,name="Warsheikh Villa 2 Room",theatre_cap=15,classroom_cap=8,ushape_cap=8,reception_cap=15)
	h10 = ConferenceHall.objects.create(branch_id=b1,name="Hargeisa OB 3 Room",theatre_cap=10,classroom_cap=6,ushape_cap=8,reception_cap=12)
	h11 = ConferenceHall.objects.create(branch_id=b1,name="Lag Badana Room",theatre_cap=15,classroom_cap=8,ushape_cap=10,reception_cap=12)
